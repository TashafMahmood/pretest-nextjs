...
// import { membershipData } from "../plan/membershipData";
...
//   const [networkClusterCode, setNetworkClusterCode] = useState(null);
...
//     console.log(nccode,'0000000')
//     if (!nccode) {
//       setNetworkClusterCode(false); // for clarity
//       setLoader(false);
//       return;
//     }

//     setNetworkClusterCode(nccode); // set it for conditionally rendering later
...
//         );
//         setNetworkData(res?.data?.result?.[0]);
...
//   console.log(networkClusterCode, "netowkr coe..");
//   return (
//     <div className={styles.container_div}>
//       <PaymentHeader />
//       {!networkClusterCode && <HomeComponent />}
//       {membershipStatus == membershipStatusName?.FREE_NETWORK && (
//         <PurchaseCompleted />
//       )}
//       {membershipStatus == membershipStatusName?.PAYMENT_REQUIRED && (
//         <PurchasePlan />
//       )}
